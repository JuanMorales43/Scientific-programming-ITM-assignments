...
# 1. Cargar datos
# ==========================
ruta_csv_radiomics = "/media/imagenesmedicas/DATA1/01-ImagenesMedicas-US1/08-MasterCamilo/06 - Linea base/ML/radiomics_lasso_subset.csv"
...
# ==========================
# 4. Entrenar Naive Bayes en TRAIN
# ==========================
clf = GaussianNB()
...
disp.plot(ax=ax_cm)
ax_cm.set_title('Matriz de Confusión Naive Bayes (Validación)')
fig_cm.tight_layout()
...
RocCurveDisplay.from_predictions(y_val, y_pred_proba, name='NB', pos_label=1, ax=ax_roc)
ax_roc.plot([0, 1], [0, 1], '--', label='Azar')
ax_roc.set_title('Curva ROC Naive Bayes (Validación)')
